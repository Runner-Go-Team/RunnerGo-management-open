...
const (
	...
	NoticeEventUIPlan           = 105 // UI自动化计划
	NoticeEventUIPlanReport     = 106 // UI自动化报告

	NoticeEventBatchTypeAdd  = 1 // 添加事件操作类型 1 新增 2 替换 3 删除
	NoticeEventBatchTypeRepl = 2
	NoticeEventBatchTypeDel  = 3
