...
type Config struct {
	...
	CompanyInitConfig           CompanyInitConfig `yaml:"companyInitConfig"`
	Static                      string            `yaml:"static"`
}

type CompanyInitConfig struct {
...
func initCompanyConfig() {
	Conf.CompanyInitConfig.Account = os.Getenv("RG_COMPANY_ACCOUNT")
	if Conf.CompanyInitConfig.Account == "" {
		Conf.CompanyInitConfig.Account = "runnergo"
	}
	Conf.CompanyInitConfig.Password = os.Getenv("RG_COMPANY_PASSWORD")
	if Conf.CompanyInitConfig.Password == "" {
		Conf.CompanyInitConfig.Password = "runnergo"
	}
	Conf.CompanyInitConfig.Name = os.Getenv("RG_COMPANY_NAME")
	if Conf.CompanyInitConfig.Name == "" {
		Conf.CompanyInitConfig.Name = "runnergo"
	}
}

func initStatic() {
	Conf.Static = os.Getenv("RG_STATIC")
	if Conf.Static == "" {
		Conf.Static = "./data/static/"
	}
}
