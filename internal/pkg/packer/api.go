...
func TransMaoAPIReqToSaveTarget(api *mao.API) *rao.SaveTargetReq {
	target := &rao.SaveTargetReq{
...
func GetJustSendTargetParam(req *rao.SaveTargetReq, globalVariable rao.GlobalVariable) rao.RunTargetParam {
	if req.EnvInfo.EnvID != 0 {
		req.Request.PreUrl = req.EnvInfo.PreUrl
		req.WebsocketDetail.Url = req.EnvInfo.PreUrl + req.WebsocketDetail.Url
		req.TcpDetail.Url = req.EnvInfo.PreUrl + req.TcpDetail.Url
	}
	...
	return rao.RunTargetParam{
		...
		Request:         req.Request,
		GlobalVariable:  globalVariable,
		SqlDetail:       req.SqlDetail,
		TcpDetail:       req.TcpDetail,
		WebsocketDetail: req.WebsocketDetail,
		DubboDetail:     req.DubboDetail,
	}
}
