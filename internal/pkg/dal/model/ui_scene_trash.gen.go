...
const TableNameUISceneTrash = "ui_scene_trash"

// UISceneTrash mapped from table <ui_scene_trash>
...
// TableName UISceneTrash's table name
func (*UISceneTrash) TableName() string {
	return TableNameUISceneTrash
}
