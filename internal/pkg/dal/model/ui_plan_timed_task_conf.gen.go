...
const TableNameUIPlanTimedTaskConf = "ui_plan_timed_task_conf"

// UIPlanTimedTaskConf mapped from table <ui_plan_timed_task_conf>
...
// TableName UIPlanTimedTaskConf's table name
func (*UIPlanTimedTaskConf) TableName() string {
	return TableNameUIPlanTimedTaskConf
}
