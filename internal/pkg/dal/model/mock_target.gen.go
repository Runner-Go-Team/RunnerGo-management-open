...
const TableNameMockTarget = "mock_target"

// MockTarget mapped from table <mock_target>
type MockTarget struct {
	...
	Source        int32          `gorm:"column:source;not null" json:"source"`                                   // 数据来源：0-mock管理
...
// TableName MockTarget's table name
func (*MockTarget) TableName() string {
	return TableNameMockTarget
}
