...
func newCompany(db *gorm.DB, opts ...gen.DOOption) company {
	...
	_company.CompanyID = field.NewString(tableName, "company_id")
	_company.Name = field.NewString(tableName, "name")
	_company.Logo = field.NewString(tableName, "logo")
	_company.ExpireAt = field.NewTime(tableName, "expire_at")
...
type company struct {
	...
	Name      field.String // 企业名称
	Logo      field.String // 企业logo
	ExpireAt  field.Time   // 服务到期时间
...
func (c *company) updateTableName(table string) *company {
	...
	c.CompanyID = field.NewString(table, "company_id")
