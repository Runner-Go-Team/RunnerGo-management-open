...
func newOperation(db *gorm.DB, opts ...gen.DOOption) operation {
	...
	_operation.TeamID = field.NewString(tableName, "team_id")
	_operation.UserID = field.NewString(tableName, "user_id")
...
type operation struct {
	...
	Category  field.Int32  // 日志类型：1-新建，2-修改，3-删除，4-运行，5-调试，6-执行
