...
func GetAllAlterSqlMap() map[string][]string {
	...
	// management版本2.2.0
	v220 := make([]string, 0, 10)
	v220 = append(v220, "ALTER TABLE stress_plan_report ADD `run_duration_time` bigint(20) NOT NULL DEFAULT '0' COMMENT '任务运行持续时长' after debug_mode;")
	alterSqlMap["2.2.0"] = v220

	// management版本2.1.0
	v210 := make([]string, 0, 10)
	v210 = append(v210, "DROP TABLE IF EXISTS target_debug_log;")
	v210 = append(v210, "DROP TABLE IF EXISTS mock_target_debug_log;")
	alterSqlMap["2.1.0"] = v210
